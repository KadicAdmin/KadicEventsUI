  ...
  template: `
    <div class="p-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <app-card header="Events" customClass="bg-blue-50 border-blue-200">
        ...
        <app-card header="Speakers" customClass="bg-green-50 border-green-200">
          <div class="text-center">
      ...
      <div class="mt-8">
        <app-card header="Recent Activity">
          <p class="text-gray-600">
            Welcome to the Kadic Events Management System!
          </p>
          <p class="text-gray-600 mt-2">
            Use the navigation to manage events, speakers, and participants.
          </p>
        </app-card>
      </div>
    </div>
