...
@Component({
    ...
    <div class="space-y-4">
      ...
      <div class="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center hover:border-blue-400 transition-colors cursor-pointer"
        ...
        (drop)="onDrop($event)">
        <input #fileInput type="file" accept="image/*" [multiple]="allowMultiple()" 
        ...
        <div class="flex flex-col items-center gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-gray-500">Arrastra y suelta o haz click para seleccionar</p>
      ...
      <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        <div class="group relative bg-gray-50 rounded-xl overflow-hidden border border-gray-200 hover:border-blue-400 transition-all">
          <!-- Image Preview -->
          ...
          <div class="absolute top-2 left-2">
            <span class="inline-flex items-center gap-1 px-2 py-1 bg-yellow-500 text-white text-xs font-semibold rounded-lg shadow-lg">
          ...
          <div class="absolute top-2 right-2">
            <span class="inline-flex items-center justify-center w-6 h-6 bg-gray-900/70 text-white text-xs font-semibold rounded-full">
              {{ idx + 1 }}
            </span>
          </div>
        </div>
      ...
      <div class="flex items-center justify-between text-sm text-gray-600 pt-2">
        ...
        @if (allowMultiple()) {
        <p-button label="Limpiar todo" icon="pi pi-trash" size="small" [text]="true" severity="danger"
          (onClick)="clearAll()" />
        }
      </div>
      }
