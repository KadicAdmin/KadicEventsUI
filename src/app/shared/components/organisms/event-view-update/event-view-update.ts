...
import { ProductService } from 'app/features/events/services/productservice';
...
@Component({
  selector: 'app-event-view-update',
  imports: [
    DataView,
    Tag,
    // Rating,
  ...
  template: `
    <h1 class="text-2xl font-bold p-4">Actualizar Evento</h1>
