...
@Component({
  ...
  template: `
    <p-dialog [visible]="visible()" (visibleChange)="onVisibleChange.emit($event)" [modal]="true" 
      [style]="{width: '700px', maxHeight: '90vh'}" [draggable]="false" [resizable]="false" 
      ...
      <ng-template pTemplate="header">
        <div class="flex items-center gap-3">
          ...
          <div>
            ...
            <p class="text-sm text-gray-500">Información completa del ponente</p>
          </div>
        </div>
      </ng-template>
            ...
            <p-tabpanel value="1">
              <div class="space-y-4 py-4">
                ...
                <div class="space-y-2">
                  ...
                  <p-select formControlName="academicTitleId" [options]="academicTitles()" 
                ...
                <div class="space-y-2">
                  ...
                  <p-select formControlName="academicLevelId" [options]="academicLevels()" 
                ...
                <div class="space-y-2">
                  ...
                  <p-select formControlName="studyAreaId" [options]="studyAreas()" 
      ...
      <ng-template pTemplate="footer">
        <div class="flex justify-end gap-2">
          ...
          <p-button label="Guardar" (onClick)="onSave.emit()" icon="pi pi-check" />
        </div>
      </ng-template>
    </p-dialog>
  `,
