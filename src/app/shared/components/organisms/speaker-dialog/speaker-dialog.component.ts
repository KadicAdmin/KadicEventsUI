...
@Component({
  ...
  template: `
    ...
    >
      ...
      <!-- Mode Selector -->
      <div
        class="flex items-center justify-center gap-6 mb-6 p-4 bg-gray-50 rounded-xl border border-gray-200"
      >
        <div class="flex items-center gap-2">
          ...
          <label
            for="mode-select"
            class="font-medium cursor-pointer flex items-center gap-2 text-gray-700"
          >
      ...
      <div class="p-6">
        <div class="space-y-6">
          ...
          <div class="text-center">
            <h3
              class="text-lg font-semibold text-gray-800 mb-2 flex items-center justify-center gap-2"
            >
            ...
            <p class="text-sm text-gray-600">
              Navega por los speakers disponibles y selecciona uno haciendo
              click en su tarjeta
            </p>
          </div>
                ...
                <div class="p-3">
                  ...
                  >
                    ...
                    <div class="absolute top-2 right-2 z-10">
                      <div
                        class="w-7 h-7 bg-green-500 text-white rounded-full flex items-center justify-center text-sm font-bold shadow-lg border-2 border-white"
                      >
                        ✓
                      </div>
                    </div>
                    ...
                    <div
                      class="h-32 bg-gray-100 rounded-t-xl flex items-center justify-center overflow-hidden flex-shrink-0"
                    >
                    ...
                    <div
                      class="h-16 p-2 text-center space-y-1 flex flex-col justify-between"
                    >
                      <!-- Name -->
                      ...
                      <div class="flex flex-wrap gap-1 justify-center">
                        ...
                        <span
                          class="px-1.5 py-0.5 bg-blue-50 text-blue-700 text-xs rounded-full border border-blue-200"
                        >
                          {{ speaker.academicTitle.name }}
                        </span>
                        } @if (speaker.isActive) {
                        <span
                          class="px-1.5 py-0.5 bg-green-50 text-green-700 text-xs rounded-full border border-green-200"
                        >
          ...
          <div class="text-center py-12">
            ...
            <p class="text-gray-500 text-sm mb-4">
              Crea un nuevo speaker usando la opción "Crear Nuevo"
            </p>
            <p-button
            ...
            <div class="flex items-center gap-3">
              ...
              <div>
                <p class="font-medium text-green-900">
                  {{ selectedSpeakerIds().length }} Speaker{{
                    selectedSpeakerIds().length > 1 ? 's' : ''
                  }}
                  Seleccionado{{ selectedSpeakerIds().length > 1 ? 's' : '' }}
                </p>
                <p class="text-sm text-green-700">
                  Haz clic en "Seleccionar" para agregar{{
                    selectedSpeakerIds().length > 1 ? 'los' : 'lo'
                  }}
                  al evento
                </p>
              </div>
      ...
      <form [formGroup]="speakerForm()!" class="pt-4">
        ...
        <p-tabs value="0">
          ...
          <p-tabpanels>
            ...
            <p-tabpanel value="1">
              <div class="space-y-4 py-4">
                ...
                <div class="space-y-2">
                  ...
                  >
                  <p-select
                    formControlName="academicDegreesId"
                ...
                <div class="space-y-2">
                  ...
                  >
                  <p-select
                    formControlName="academicLevelsId"
            ...
            <!--Esto es para agregarlo para el siguiente sprint -->
  ...
  handleSave() {
    if (this.speakerMode() === 'select') {
      ...
      if (selectedIds.length > 0) {
        const selectedSpeakers = this.availableSpeakers().filter((s) =>
