...
export const IMAGES_SLIDESHOW: ImgProps[] = [
  {
    ...
    description:
      'El evento de rock más esperado del año. Artistas internacionales y nacionales en un festival inolvidable.',
  },
  {
    ...
    description:
      'La cumbre tecnológica más importante del país. Innovación, networking y oportunidades de negocio.',
  },
  {
    ...
    description:
      'La exposición de bodas más exclusiva. Proveedores premium y las últimas tendencias en eventos nupciales.',
  },
  {
    ...
    description:
      'Gala corporativa de alto nivel con cena de gala, networking y reconocimientos empresariales.',
  },
  {
    ...
    description:
      'Festival gastronómico con los mejores chefs, vinos premium y experiencias culinarias únicas.',
  },
  {
    ...
    description:
      'Seminario especializado en estrategias de negocio, liderazgo y desarrollo empresarial.',
  },
];
